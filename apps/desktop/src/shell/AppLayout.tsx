        ...
        >
          ...
          : <div className={styles.navigationRow} key={item.path}>
            <NavLink to={item.path} end={item.path === "/"}>
              ...
              >
                {cursorHarness.settings_applied ? "Taken over" : "Not taken over"}
              </span>}
    ...
    <main className={styles.content}>
      <div className={styles.actionRegion}>
        <Card className={styles.actions}>
          ...
          {location.pathname !== "/" && <TooltipTrigger label={"Refresh"}><button className={controls.iconButton} aria-label={"Refresh"} disabled={busy} onClick={() => void appStore.refresh()}>
