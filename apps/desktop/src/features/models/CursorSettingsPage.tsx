...
export function CursorSettingsPage() {
  ...
  /** Only the group being toggled enters a busy state, so other switches never grey out. */
  ...
  /** The group switch: disabled groups' models stop being published to Cursor but stay configured. */
